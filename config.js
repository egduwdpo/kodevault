/* =========================================================
   ISI DUA BARIS INI dengan data project Supabase kamu sendiri.
   Ambil dari: Supabase Dashboard -> Project Settings -> API
   - "Project URL"      -> SUPABASE_URL
   - "anon public" key  -> SUPABASE_ANON_KEY
   Aman ditaruh di frontend/GitHub — kunci "anon" memang didesain
   untuk dipakai di sisi klien, keamanan datanya diatur lewat
